  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/producto/listar" :name="$t('Listar Productos')" icon="tim-icons icon-atom"/>
        <sidebar-link to="/producto/crear" :name="$t('Agregar Producto')" icon="tim-icons icon-pin"/>
